...
import 'package:ecommerce_app/src/features/cart/ui/add_to_cart/add_to_cart_widget.dart';
...
import 'package:ecommerce_app/src/features/products/ui/product_screen/leave_review_action.dart';
import 'package:ecommerce_app/src/features/products/ui/product_screen/product_average_rating.dart';
import 'package:ecommerce_app/src/features/reviews/ui/product_reviews/product_reviews_list.dart';
    ...
    return Scaffold(
      ...
      body: Consumer(
        builder: (context, ref, _) { 
          final product = ref.watch(productFutureRepositoryProvider(productId));
          ...
          return product.when(
            ...
            error: (error, st) => ErrorWidget(error.toString()),
