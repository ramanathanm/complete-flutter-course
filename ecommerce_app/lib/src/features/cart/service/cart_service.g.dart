...
String _$cartServiceHash() => r'a8df91bdeb09b05a79a6af4aab75bcd1f2b1187b';
...
String _$itemAvailableQuantityHash() =>
    r'a90dedad128c587969189b08ed709b86727f8284';
...
/// See also [itemAvailableQuantity].
class ItemAvailableQuantityProvider extends Provider<int> {
  /// See also [itemAvailableQuantity].
...
mixin ItemAvailableQuantityRef on ProviderRef<int> {
  /// The parameter `product` of this provider.
  Product get product;
}

class _ItemAvailableQuantityProviderElement extends ProviderElement<int>
    with ItemAvailableQuantityRef {
...
String _$cartTotalHash() => r'd8a1ff3125f90c609c421c4dea44c4410f4ce08b';
